"""
Django settings for soft_butterfly_41450 project.
...
ROOT_URLCONF = 'soft_butterfly_41450.urls'
...
WSGI_APPLICATION = 'soft_butterfly_41450.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "soft_butterfly_41450 API",
    "DESCRIPTION": "API documentation for soft_butterfly_41450 App",
    "VERSION": "v1",
}
